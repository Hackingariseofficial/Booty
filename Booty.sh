...
#
# ----------------------------------------------------------------------------
# well not my best work but fuck it
# 
#
# 
# ----------------------------------------------------------------------------
...
usage(){
	...
	echo "THE ONE AND ONLY LAUGHINGMAN"
	echo
	echo "SIMPLE AND EASY WORDLISTS LAUGHINGMAN STYLE."
	echo
	echo "EIDT THE CONFIG FILE BOOTY.CFG [Booty.cfg]"
	echo
	echo "USAGE"
	echo "   $0"
